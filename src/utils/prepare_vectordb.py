...
class PrepareVectorDB:
    """
    A class for preparing and saving a VectorDB using HuggingFace embeddings.

    This class facilitates the process of loading documents, chunking them, and creating a VectorDB
    with HuggingFace embeddings. It provides methods to prepare and save the VectorDB.
    ...
    Parameters:
        ...
        embedding_model_engine (str): The engine for HuggingFace embeddings.
    ...
    def __init__(
        ...
        self.embedding = HuggingFaceEmbeddings(model_name=self.embedding_model_engine)
    ...
    def prepare_and_save_vectordb(self):
        """
        Load, chunk, and create a VectorDB with HuggingFace embeddings, and save it.
